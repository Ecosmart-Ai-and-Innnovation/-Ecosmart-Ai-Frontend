    ...
    return (
      <div className="min-h-screen bg-white font-sans flex flex-col relative overflow-hidden">
        ...
        <main className="relative z-10 flex-grow flex flex-col items-center justify-center px-6">
          ...
          <Link href="/auth/recycler/forgot-password" className="mt-6 bg-[#549B45] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#458237] transition-all">
            Request Reset Link
          </Link>
        </main>
      </div>
  ...
  return (
    <div className="min-h-screen bg-white font-sans flex flex-col relative overflow-hidden">
      ...
      <header className="relative z-20 w-full flex justify-between items-center px-6 md:px-12 lg:px-24 pt-6 pb-4">
        ...
        {/* Back Button */}
        <Link href="/auth/recycler/sign-in" className="flex items-center gap-2 text-gray-600 hover:text-gray-900 transition-colors font-medium text-sm md:text-base z-10">
